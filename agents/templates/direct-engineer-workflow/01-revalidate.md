...
stepIndex: 1
layer: 1
agent: spec-revalidator-luna-high
approvalGate: false
optional: false
...
input is untraceable, collect concrete tree evidence and call `inbox_ask` with exactly these choices (stable IDs and labels):
