...
const drivenWait = async ({ blockedPolls, stepMs, waitBudgetMs, alertIntervalMs, runs }) => {
  let clock = 0;
  let polls = 0;
  const holds = [];
  const alerts = [];
