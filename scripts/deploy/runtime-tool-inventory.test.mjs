...
const DECLARED_FILES = [
  ...
  { source: "packages/runner/runtime-tools/merge-train.sh", destination: "merge-train.sh" },
  { source: "packages/runner/runtime-tools/merge-train.mjs", destination: "merge-train.mjs" },
...
const DECLARED_DIRECTORY_ENTRIES = [
  ["", ["git-credential-runner.sh", "merge-train.sh", "merge-train.mjs", "regression-verification.sh", "gate-worker"]],
